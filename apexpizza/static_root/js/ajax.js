...
function button_clicked(sender){
    ...
    if (sender.includes("remove")){
        ...
        if (Number.isInteger(parseInt(phone.replace("+", "").replace("-", "").replace(" ", "")))){
            console.log(phone.replace("+", "").replace("-", "").replace(" ", ""))
    ...
    }  else if (sender.includes("cash_back_mobile")){
        $('.header-mobile-cashback-info').toggleClass('visible');
    } else if (sender.includes("cash_back_close")){
        $('.header-mobile-cashback-info').toggleClass('visible');
